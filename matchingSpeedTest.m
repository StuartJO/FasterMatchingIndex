...
smoothed_cumsum_t = movmean(cumsum(mean(t)),100);
smoothed_cumsum_t_ = movmean(cumsum(mean(t_)),100);

plot(smoothed_cumsum_t)
hold on
plot(smoothed_cumsum_t_)

plot(smoothed_cumsum_t_./smoothed_cumsum_t)
...
save('matchingSpeedTestData7.mat')
